...
import HomeWithNewHeader from '@/pages/HomeWithNewHeader';
...
// PlaceholderPage must be inside BrowserRouter to use useNavigate
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <AppProvider>
                <Routes>
                  <Route path="/"              element={<HomeWithNewHeader />} />
                  <Route path="/home"          element={<HomeWithNewHeader />} />
                  <Route path="/old-home"      element={<AmazonHome />} />
