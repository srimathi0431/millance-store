...
const statusBadge = (s: string) => {
  ...
  return (
    <span style={{ display: 'inline-flex', alignItems: 'center', padding: '3px 10px', borderRadius: 20, background: st.bg, color: st.color, fontSize: 12, fontWeight: 700, textTransform: 'uppercase' as const }}>
      {s.replace('_', ' ')}
    </span>
  );
};
