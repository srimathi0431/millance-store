...
const statusColor = (s:string) => ({PENDING:'warning',SUCCESS:'success',FAILED:'danger',REFUNDED:'purple',PARTIALLY_REFUNDED:'info'}[s]||'gray');
...
const PaymentsPage: React.FC = () => {
  ...
  const refundMut = useMutation({
    mutationFn: ({ orderId, amount, reason }:any) => paymentsApi.refund(orderId, parseFloat(amount), reason||undefined),
