...
const SubCategoriesPage= () => {
 ...
 onError: (e) => toast('error', e?.response?.data?.message || 'Cannot delete — products depend on this subcategory'),
 });
 ...
 onMouseEnter={e => { const el = e.currentTarget; el.style.transform = 'translateY(-3px)'; el.style.boxShadow = `0 8px 24px rgba(15,23,42,0.12)`; el.style.borderColor = color; }}
