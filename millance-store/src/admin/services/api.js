...
// ── Products ──────────────────────────────────────────────────
export const productsApi = USE_MOCK_API ? mockProductsApi : {
 list: (params = {}) =>
...
// ── Categories ────────────────────────────────────────────────
export const categoriesApi = USE_MOCK_API ? mockCategoriesApi : {
 list: (params = {}) =>
...
// ── Inventory ─────────────────────────────────────────────────
export const inventoryApi = USE_MOCK_API ? mockInventoryApi : {
 list: (params = {}) =>
...
// ── Payments & Refunds ────────────────────────────────────────
export const paymentsApi = USE_MOCK_API ? mockPaymentsApi : {
 list: (params = {}) =>
...
// ── Coupons ───────────────────────────────────────────────────
export const couponsApi = USE_MOCK_API ? mockCouponsApi : {
 list: (params = {}) =>
...
// ── Reviews ───────────────────────────────────────────────────
export const reviewsApi = USE_MOCK_API ? mockReviewsApi : {
 list: (params = {}) =>
