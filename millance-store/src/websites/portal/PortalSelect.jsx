...
const PortalSelect= () => {
 ...
 (e.currentTarget).style.borderColor = 'rgba(255,122,0,0.7)';
 (e.currentTarget).style.transform = 'translateY(-4px)';
 (e.currentTarget).style.boxShadow = '0 16px 40px rgba(255,122,0,0.2)';
 }}
 onMouseLeave={e => {
 ...
 onMouseEnter={e => {
 (e.currentTarget).style.background = 'rgba(123,47,247,0.12)';
 (e.currentTarget).style.borderColor = 'rgba(123,47,247,0.7)';
 (e.currentTarget).style.transform = 'translateY(-4px)';
 (e.currentTarget).style.boxShadow = '0 16px 40px rgba(123,47,247,0.2)';
 }}
 onMouseLeave={e => {
 (e.currentTarget).style.background = 'rgba(255,255,255,0.05)';
